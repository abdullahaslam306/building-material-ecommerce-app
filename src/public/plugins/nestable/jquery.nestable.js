...
(function ($, window, document, undefined) {
  ...
  Plugin.prototype = {
    ...
    init() {
      ...
      $.each(this.el.find(list.options.itemNodeName), (k, el) => {
        list.setParent($(el));
      });
      ...
      list.el.on('click', 'button', (e) => {
        ...
        const item = target.parent(list.options.itemNodeName);
        if (action === 'collapse') {
    ...
    dragStart(e) {
      ...
      let i; let depth;
      const items = this.dragEl.find(this.options.itemNodeName);
    ...
    dragMove(e) {
      let list; let parent; let prev; let next; let depth;
