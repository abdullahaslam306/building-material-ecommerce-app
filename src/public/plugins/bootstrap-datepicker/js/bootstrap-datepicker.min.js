...
!(function (a) { typeof define === 'function' && define.amd ? define(['jquery'], a) : a(typeof exports === 'object' ? require('jquery') : jQuery); }((a, b) => {
  function c() { return new Date(Date.UTC.apply(Date, arguments)); } function d() { const a = new Date(); return c(a.getFullYear(), a.getMonth(), a.getDate()); } function e(a, b) { return a.getUTCFullYear() === b.getUTCFullYear() && a.getUTCMonth() === b.getUTCMonth() && a.getUTCDate() === b.getUTCDate(); } function f(a) { return function () { return this[a].apply(this, arguments); }; } function g(a) { return a && !isNaN(a.getTime()); } function h(b, c) { function d(a, b) { return b.toLowerCase(); } let e; const f = a(b).data(); const g = {}; const h = new RegExp(`^${c.toLowerCase()}([A-Z])`); c = new RegExp(`^${c.toLowerCase()}`); for (const i in f)c.test(i) && (e = i.replace(h, d), g[e] = f[i]); return g; } function i(b) { const c = {}; if (q[b] || (b = b.split('-')[0], q[b])) { const d = q[b]; return a.each(p, (a, b) => { b in d && (c[b] = d[b]); }), c; } } var j = (function () {
    const b = {
      get(a) { return this.slice(a)[0]; }, contains(a) { for (let b = a && a.valueOf(), c = 0, d = this.length; d > c; c++) if (this[c].valueOf() - b >= 0 && this[c].valueOf() - b < 864e5) return c; return -1; }, remove(a) { this.splice(a, 1); }, replace(b) { b && (a.isArray(b) || (b = [b]), this.clear(), this.push.apply(this, b)); }, clear() { this.length = 0; }, copy() { const a = new j(); return a.replace(this), a; },
    }; return function () { const c = []; return c.push.apply(c, arguments), a.extend(c, b), c; };
  }()); const k = function (b, c) { a.data(b, 'datepicker', this), this._process_options(c), this.dates = new j(), this.viewDate = this.o.defaultViewDate, this.focusDate = null, this.element = a(b), this.isInput = this.element.is('input'), this.inputField = this.isInput ? this.element : this.element.find('input'), this.component = this.element.hasClass('date') ? this.element.find('.add-on, .input-group-addon, .btn') : !1, this.component && this.component.length === 0 && (this.component = !1), this.isInline = !this.component && this.element.is('div'), this.picker = a(r.template), this._check_template(this.o.templates.leftArrow) && this.picker.find('.prev').html(this.o.templates.leftArrow), this._check_template(this.o.templates.rightArrow) && this.picker.find('.next').html(this.o.templates.rightArrow), this._buildEvents(), this._attachEvents(), this.isInline ? this.picker.addClass('datepicker-inline').appendTo(this.element) : this.picker.addClass('datepicker-dropdown dropdown-menu'), this.o.rtl && this.picker.addClass('datepicker-rtl'), this.o.calendarWeeks && this.picker.find('.datepicker-days .datepicker-switch, thead .datepicker-title, tfoot .today, tfoot .clear').attr('colspan', (a, b) => Number(b) + 1), this._allow_update = !1, this.setStartDate(this._o.startDate), this.setEndDate(this._o.endDate), this.setDaysOfWeekDisabled(this.o.daysOfWeekDisabled), this.setDaysOfWeekHighlighted(this.o.daysOfWeekHighlighted), this.setDatesDisabled(this.o.datesDisabled), this.setViewMode(this.o.startView), this.fillDow(), this.fillMonths(), this._allow_update = !0, this.update(), this.isInline && this.show(); }; k.prototype = {
    constructor: k,
    _resolveViewName(b) { return a.each(r.viewModes, (c, d) => (b === c || a.inArray(b, d.names) !== -1 ? (b = c, !1) : void 0)), b; },
    ...
    fillDow() { let b = this.o.weekStart; let c = '<tr>'; for (this.o.calendarWeeks && (c += '<th class="cw">&#160;</th>'); b < this.o.weekStart + 7;)c += '<th class="dow', a.inArray(b, this.o.daysOfWeekDisabled) !== -1 && (c += ' disabled'), c += `">${q[this.o.language].daysMin[b++ % 7]}</th>`; c += '</tr>', this.picker.find('.datepicker-days thead').append(c); },
    ...
    fill() {
      let d; let e; const f = new Date(this.viewDate); const g = f.getUTCFullYear(); const h = f.getUTCMonth(); const i = this.o.startDate !== -(1 / 0) ? this.o.startDate.getUTCFullYear() : -(1 / 0); const j = this.o.startDate !== -(1 / 0) ? this.o.startDate.getUTCMonth() : -(1 / 0); const k = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCFullYear() : 1 / 0; const l = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCMonth() : 1 / 0; const m = q[this.o.language].today || q.en.today || ''; const n = q[this.o.language].clear || q.en.clear || ''; const o = q[this.o.language].titleFormat || q.en.titleFormat; if (!isNaN(g) && !isNaN(h)) {
        this.picker.find('.datepicker-days .datepicker-switch').text(r.formatDate(f, o, this.o.language)), this.picker.find('tfoot .today').text(m).toggle(this.o.todayBtn !== !1), this.picker.find('tfoot .clear').text(n).toggle(this.o.clearBtn !== !1), this.picker.find('thead .datepicker-title').text(this.o.title).toggle(this.o.title !== ''), this.updateNavArrows(), this.fillMonths(); const p = c(g, h, 0); const s = p.getUTCDate(); p.setUTCDate(s - (p.getUTCDay() - this.o.weekStart + 7) % 7); let t = new Date(p); p.getUTCFullYear() < 100 && t.setUTCFullYear(p.getUTCFullYear()), t.setUTCDate(t.getUTCDate() + 42), t = t.valueOf(); for (var u, v, w = []; p.valueOf() < t;) { if (u = p.getUTCDay(), u === this.o.weekStart && (w.push('<tr>'), this.o.calendarWeeks)) { const x = new Date(+p + (this.o.weekStart - u - 7) % 7 * 864e5); const y = new Date(Number(x) + (11 - x.getUTCDay()) % 7 * 864e5); var z = new Date(Number(z = c(y.getUTCFullYear(), 0, 1)) + (11 - z.getUTCDay()) % 7 * 864e5); const A = (y - z) / 864e5 / 7 + 1; w.push(`<td class="cw">${A}</td>`); }v = this.getClassNames(p), v.push('day'), this.o.beforeShowDay !== a.noop && (e = this.o.beforeShowDay(this._utc_to_local(p)), e === b ? e = {} : typeof e === 'boolean' ? e = { enabled: e } : typeof e === 'string' && (e = { classes: e }), e.enabled === !1 && v.push('disabled'), e.classes && (v = v.concat(e.classes.split(/\s+/))), e.tooltip && (d = e.tooltip)), v = a.unique(v), w.push(`<td class="${v.join(' ')}"${d ? ` title="${d}"` : ''}${this.o.dateCells ? ` data-date="${p.getTime().toString()}"` : ''}>${p.getUTCDate()}</td>`), d = null, u === this.o.weekEnd && w.push('</tr>'), p.setUTCDate(p.getUTCDate() + 1); } this.picker.find('.datepicker-days tbody').html(w.join('')); const B = q[this.o.language].monthsTitle || q.en.monthsTitle || 'Months'; const C = this.picker.find('.datepicker-months').find('.datepicker-switch').text(this.o.maxViewMode < 2 ? B : g).end()
          .find('tbody span')
          .removeClass('active'); if (a.each(this.dates, (a, b) => { b.getUTCFullYear() === g && C.eq(b.getUTCMonth()).addClass('active'); }), (i > g || g > k) && C.addClass('disabled'), g === i && C.slice(0, j).addClass('disabled'), g === k && C.slice(l + 1).addClass('disabled'), this.o.beforeShowMonth !== a.noop) { const D = this; a.each(C, (c, d) => { const e = new Date(g, c, 1); let f = D.o.beforeShowMonth(e); f === b ? f = {} : typeof f === 'boolean' ? f = { enabled: f } : typeof f === 'string' && (f = { classes: f }), f.enabled !== !1 || a(d).hasClass('disabled') || a(d).addClass('disabled'), f.classes && a(d).addClass(f.classes), f.tooltip && a(d).prop('title', f.tooltip); }); } this._fill_yearsView('.datepicker-years', 'year', 10, 1, g, i, k, this.o.beforeShowYear), this._fill_yearsView('.datepicker-decades', 'decade', 100, 10, g, i, k, this.o.beforeShowDecade), this._fill_yearsView('.datepicker-centuries', 'century', 1e3, 100, g, i, k, this.o.beforeShowCentury);
      }
    },
    updateNavArrows() { if (this._allow_update) { let a; let b; const c = new Date(this.viewDate); const d = c.getUTCFullYear(); const e = c.getUTCMonth(); switch (this.viewMode) { case 0: a = this.o.startDate !== -(1 / 0) && d <= this.o.startDate.getUTCFullYear() && e <= this.o.startDate.getUTCMonth(), b = this.o.endDate !== 1 / 0 && d >= this.o.endDate.getUTCFullYear() && e >= this.o.endDate.getUTCMonth(); break; case 1: case 2: case 3: case 4: a = this.o.startDate !== -(1 / 0) && d <= this.o.startDate.getUTCFullYear(), b = this.o.endDate !== 1 / 0 && d >= this.o.endDate.getUTCFullYear(); } this.picker.find('.prev').toggleClass('disabled', a), this.picker.find('.next').toggleClass('disabled', b); } },
    click(b) { b.preventDefault(), b.stopPropagation(); let e; let f; let g; let h; let i; e = a(b.target), e.hasClass('datepicker-switch') && this.setViewMode(this.viewMode + 1), e.hasClass('today') && !e.hasClass('day') && (this.setViewMode(0), this._setDate(d(), this.o.todayBtn === 'linked' ? null : 'view')), e.hasClass('clear') && this.clearDates(), e.hasClass('disabled') || (e.hasClass('day') && (g = Number(e.text()), h = this.viewDate.getUTCFullYear(), i = this.viewDate.getUTCMonth(), (e.hasClass('old') || e.hasClass('new')) && (f = e.hasClass('old') ? -1 : 1, i = (i + f + 12) % 12, (f === -1 && i === 11 || f === 1 && i === 0) && (h += f, this._trigger('changeYear', this.viewDate)), this._trigger('changeMonth', this.viewDate)), this._setDate(c(h, i, g))), (e.hasClass('month') || e.hasClass('year') || e.hasClass('decade') || e.hasClass('century')) && (this.viewDate.setUTCDate(1), g = 1, this.viewMode === 1 ? (i = e.parent().find('span').index(e), h = this.viewDate.getUTCFullYear(), this.viewDate.setUTCMonth(i)) : (i = 0, h = Number(e.text()), this.viewDate.setUTCFullYear(h)), this._trigger(r.viewModes[this.viewMode - 1].e, this.viewDate), this.viewMode === this.o.minViewMode ? this._setDate(c(h, i, g)) : (this.setViewMode(this.viewMode - 1), this.fill()))), this.picker.is(':visible') && this._focused_from && this._focused_from.focus(), delete this._focused_from; },
    navArrowsClick(b) { const c = a(b.target); let d = c.hasClass('prev') ? -1 : 1; this.viewMode !== 0 && (d *= 12 * r.viewModes[this.viewMode].navStep), this.viewDate = this.moveMonth(this.viewDate, d), this._trigger(r.viewModes[this.viewMode].e, this.viewDate), this.fill(); },
    ...
    setViewMode(a) { this.viewMode = a, this.picker.children('div').hide().filter(`.datepicker-${r.viewModes[this.viewMode].clsName}`).show(), this.updateNavArrows(); },
    ...
    updateDates() { this.dates = a.map(this.pickers, (a) => a.getUTCDate()), this.updateRanges(); }, updateRanges() { const b = a.map(this.dates, (a) => a.valueOf()); a.each(this.pickers, (a, c) => { c.setRange(b); }); }, dateUpdated(c) { if (!this.updating) { this.updating = !0; const d = a.data(c.target, 'datepicker'); if (d !== b) { const e = d.getUTCDate(); const f = this.keepEmptyValues; const g = a.inArray(c.target, this.inputs); let h = g - 1; let i = g + 1; const j = this.inputs.length; if (g !== -1) { if (a.each(this.pickers, (a, b) => { b.getUTCDate() || b !== d && f || b.setUTCDate(e); }), e < this.dates[h]) for (;h >= 0 && e < this.dates[h];) this.pickers[h--].setUTCDate(e); else if (e > this.dates[i]) for (;j > i && e > this.dates[i];) this.pickers[i++].setUTCDate(e); this.updateDates(), delete this.updating; } } } }, destroy() { a.map(this.pickers, (a) => { a.destroy(); }), delete this.element.data().datepicker; }, remove: f('destroy'),
  ...
  a.fn.datepicker.DPGlobal = r, a.fn.datepicker.noConflict = function () { return a.fn.datepicker = m, this; }, a.fn.datepicker.version = '1.7.0-dev', a(document).on('focus.datepicker.data-api click.datepicker.data-api', '[data-provide="datepicker"]', function (b) { const c = a(this); c.data('datepicker') || (b.preventDefault(), n.call(c, 'show')); }), a(() => { n.call(a('[data-provide="datepicker-inline"]')); });
}));
